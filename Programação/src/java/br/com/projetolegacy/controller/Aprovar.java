 ...
 * @author Vinicius
 */
@WebServlet(name = "Aprovar", urlPatterns = {"/Aprovar"})
public class Aprovar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.aprovarInstituicao(oInstituicao);
            request.setAttribute("mensagem", "Instituicao Aprovada");
            request.getRequestDispatcher("Adm/precadastro.jsp").forward(request, response);
        } catch (Exception ex) {
            System.out.println("Problemas ao adicionar o produto no carrinho \n erro: " + ex.getMessage());
            ex.printStackTrace();
        }
    }
