 ...
 * @author Aluno
 */
@WebServlet(name = "CarregarCampanha", urlPatterns = {"/CarregarCampanha"})
public class CarregarCampanha extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            GenericDAO dao = new CampanhaDAOImpl();
            request.setAttribute("campanha", dao.carregar(idCampanha));
            request.getRequestDispatcher("DadosCampanha").forward(request, response);

        } catch (Exception ex) {
            System.out.println("Erro no servlet CarregarCampanha: " + ex.getMessage());
            ex.printStackTrace();
