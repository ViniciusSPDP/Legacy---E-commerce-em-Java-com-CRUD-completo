 ...
 * @author Vinicius
 */
@WebServlet(name = "DadosDoacao", urlPatterns = {"/DadosDoacao"})
public class DadosDoacao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("ListarDoacao").forward(request, response);
        } catch (Exception ex) {
            System.out.println("Erro no Servlet DadosDoacao: " + ex.getMessage());
            ex.printStackTrace();
        }
