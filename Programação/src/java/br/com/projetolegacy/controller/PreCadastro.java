 ...
 * @author Vinicius
 */
@WebServlet(name = "PreCadastro", urlPatterns = {"/PreCadastro"})
public class PreCadastro extends HttpServlet {
            ...
            if (up.formProcess(getServletContext(), request)) {
                ...
                try {
                    ...
                    if (up.getForm().get("idInstituicao").toString().equals("")) {
                        if (dao.preCadastrar(oInstituicao)) {
                    ...
                    request.getRequestDispatcher("Instituicao/precadastro.jsp").forward(request, response);
