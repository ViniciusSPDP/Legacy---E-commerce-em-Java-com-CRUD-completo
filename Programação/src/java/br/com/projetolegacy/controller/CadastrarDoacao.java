 ...
 * @author Vinicius
 */
@WebServlet(name = "CadastrarDoacao", urlPatterns = {"/CadastrarDoacao"})
public class CadastrarDoacao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        oDoacao.setPorcentagemDoacao(Double.parseDouble(request.getParameter("porcentagemDoacao")));
        ...
        try {
            ...
            mensagem = "Instituicao cadastrado com sucesso";
