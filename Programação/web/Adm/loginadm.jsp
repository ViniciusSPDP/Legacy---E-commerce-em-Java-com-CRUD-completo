...
<html>
    <head>
        ...
        <link href="${pageContext.request.contextPath}/Adm/logincss.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
        <div class="box">
            <div class="form">
                ...
                <form action="${pageContext.request.contextPath}/LogarAdm" method="post">
                    ...
                    <div class=" inputBox">
                        <input type="email" name="loginAdm" required="required">
                        <span>Email</span>
                        <i></i>
                    </div>
                    <div class="inputBox">
                        <input type="password"  name="senhaAdm" required="required">
                        <span>Senha</span>
                        <i></i>
                    </div>
                    <br>
